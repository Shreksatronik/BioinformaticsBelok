...
Вы можете изменить цвет и метод рисования.
Измените определенные ползунки для любого метода окраски.
Откройте вкладку «Выборы», чтобы изменить атомарный выбор.
Определите любые цвета в определениях цветов.
![interface](https://github.com/Shreksatronik/BioinformaticsBelok/assets/90185952/0217d0eb-7424-4623-a96e-44346c64905a)
